import { addTodolistAC, changeTodolistAC, changeTodolistFilterAC, FilterValueType, removeTodolistAC, setTodolistsAC, todolistsReducer, TodolistType } from './todolists-reducer';
import { v1 } from 'uuid';
